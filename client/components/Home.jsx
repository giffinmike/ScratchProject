...
const arr=[
  ...
  return (
    <ListItem style={style} key={index} component="div" disablePadding>
     ...
     <Card sx={{  boxShadow: 8, border:1, borderRadius:5, maxWidth: 345, maxHeight: 345, minHeight: 345 }} display= "inline block">
        <CardContent>
      ...
      <CardMedia
        ...
        alt="green iguana"
        height="100"
        image={arr[0][index+1].thumbnail}
      />
      <CardContent>
        <Typography sx={ { fontWeight: 'light', fontFamily: 'Monospace', fontSize:10, textAlign: 'center'}} variant="body2" color="text.secondary">
          {arr[0][index+1].description}
        </Typography>
      </CardContent>
      <CardActions>
        <Button sx={{ left: 45 }} size="small" variant="outlined">Share</Button>
        <Button  sx={{ left: 45 }} size="small" variant="outlined">Save</Button>
...
export default function VirtualizedList() {
  ...
  return (
    <div >
        <Typography sx={{fontSize:40, textAlign: 'center'}}variant="h6" component="div">
                LEFT</Typography>
